...
/** Synchronous, cross-runtime SHA-256 for evidence and generated artifacts. */
export function evidenceHash(content) {
    ...
    for (let offset = 0; offset < paddedLength; offset += 64) {
        ...
        for (let index = 16; index < 64; index += 1) {
            ...
            const beforePrevious = schedule[index - 2];
        ...
        for (let index = 0; index < 64; index += 1) {
            ...
            const temporary1 = (h + sum1 + choose + sha256RoundConstants[index] + schedule[index]) >>> 0;
