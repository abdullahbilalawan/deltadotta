export function stableIdentifierHash(value) {
    let hash = 2166136261;
...
export function portableIdentifier(value, prefix = "item", maxLength = 63) {
...
export function canonicalRoleKey(title) {
...
export function roleArtifactSlugs(roles) {
