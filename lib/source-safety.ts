import type { RepositorySource } from "./organization.js";
...
const secretPatterns: Array<{ category: string; expression: RegExp }> = [
...
export function findSourceSecrets(sources: RepositorySource[]): SecretFinding[] {
